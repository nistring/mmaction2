...
model = dict(
    ...
    backbone=dict(
        type='STGCN', graph_cfg=dict(layout='gm', mode='stgcn_spatial'), in_channels=3),
...
optim_wrapper = dict(
    optimizer=dict(
        type='AdamW', lr=1e-4, betas=(0.9, 0.999), weight_decay=0.001))
